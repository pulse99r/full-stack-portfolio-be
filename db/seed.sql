...
INSERT INTO users (f_name, l_name, email, password_hash) VALUES
  ...
  ('Will','Robinson','will@lostinspace.com','robotrobot',{1,8}),
  ('Penny','Robinson','penny@lostinspace.com','robotrobot',{1,7}),
  ('Daffy','Duck','dduck@disney.com','disney');

INSERT INTO profiles (profile_id, user_id, banner, bio, related) VALUES
  ...
  (7, 'You''d think they would have given me pants!','I''ve had a great life...confounded Elmer Fudd for years, drove Daffy Duck crazy, starred in thousands of Saturday morning shows, even got to meet Michael Jordan! Cool!!','{1,2}');

  INSERT INTO profiles (topic, msg_body, date_sent, sender_id, recipient_id, reply_to) VALUES
  ('Welcome to the New Messaging App!','Here''s wishing you a great day today! And a great experience using his friendly messaging app. Connect with friends and send messages to your heart''s content!','null','1','{2,3,4,5,6,7,8,9}','null'),
  ('Happy Monday!','Heres wishing everyone a great day today...the forecast calls for a really great, sunny day!','null','1','{2,3,4,5,6,7,8,9}','null'),
  ('Happy Monday!','Thank you! Have a great day, too!!','null','3','{1}','2'),
  ('Happy Monday!','Thank you! Thanks for being a Charmed fan, Kenti!','null','4','{1}','2'),
  ('Hi Paige!','Just joined this new messaging site.  Come join us!','null','4','{5,6}','null');